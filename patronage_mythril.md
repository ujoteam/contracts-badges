# Analysis results for contracts/UjoPatronageBadges.sol

## Integer Overflow 

- Type: Warning
- Contract: Unknown
- Function name: `setTokenURI(uint256,string)`
- PC address: 850

### Description

A possible integer overflow exists in the function `setTokenURI(uint256,string)`.
The addition or multiplication may result in a value higher than the maximum representable integer.
In file: contracts/UjoPatronageBadges.sol:108
...
- Type: Warning
- Contract: Unknown
- Function name: `getTotalMintedPerCombination(string,address,uint256)`
- PC address: 1311

### Description

A possible integer overflow exists in the function `getTotalMintedPerCombination(string,address,uint256)`.
The addition or multiplication may result in a value higher than the maximum representable integer.
In file: contracts/UjoPatronageBadges.sol:119
...
A possible integer overflow exists in the function `setTokenURI(uint256,string)`.
The addition or multiplication may result in a value higher than the maximum representable integer.
In file: contracts/UjoPatronageBadges.sol:7
